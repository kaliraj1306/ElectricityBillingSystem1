...
public class ViewInformation extends JFrame implements ActionListener{
    ...
    ViewInformation(String meter){
        ...
        try{
            ...
            while(rs.next()){
                l11.setText(rs.getNString("name"));
                l12.setText(rs.getNString("meter"));
                l13.setText(rs.getNString("address"));
                l14.setText(rs.getNString("state"));
                l15.setText(rs.getNString("city"));
                l16.setText(rs.getNString("email"));
                l17.setText(rs.getNString("phone"));
